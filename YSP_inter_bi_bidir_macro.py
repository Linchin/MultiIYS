...
#   FILE_NAME:      YSP_inter_bi_bidir_macro.py
...
#   09/17/2018     a macro file to run YSP_inter_bi_bidir.py multiple times and record the results
...
with open('M0_AB_test_result_09262018.txt', 'w') as f:
    for i in range(0, 100):
        temp1, temp2, temp3, temp4 = YSP_inter_bi_bidir.main()
