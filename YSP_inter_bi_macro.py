...
#   FILE_NAME:      YSP_inter_bi_macro.py
...
#   09/17/2018     a macro file to run YSP_inter_bi.py multiple times and record the results
...
with open('M1_10_test_result_09172018.txt', 'w') as f:
    for i in range(0, 100):
        temp1, temp2, temp3, temp4 = YSP_inter_bi.main()
