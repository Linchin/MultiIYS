...
"""
File Name: 
exp23-YSP_bivariate_new_model_update.py

Note 01/27/2020 (exp23)
This is simply an updated version of exp22.
1. Add burn-in part of the Gibbs sampling
2. Partition: plot partitioning results of all Gibbs
   sampling;
3. Alpha: save all Gibbs sampling results; use the mean value 
   as the final results; use values vs. Gibbs iteration to show
   evolution;
4. Vector a: Show MSE over all time slots vs. iteration; use mean
   value as the final results.
5. In this program, we save the data to a file; In a separate 
   program, we plot the data.
6. Covariance/Precision matrix.
...
estimated_precision_mtx_save = {}
estimated_covariance_mtx_save = {}
estimated_coef_vectors_save = {}
...
data_dict["estimated_regimes"] = estimated_regimes_save
data_dict["estimated_precision_mtx"] = estimated_precision_mtx_save
data_dict["estimated_covariance_mtx"] = estimated_covariance_mtx_save
data_dict["estimated_coef_vectors"] = estimated_coef_vectors_save
data_dict["estimated_signal_mean"] = estimated_signal_mean_save
data_dict["estimated_alpha"] = estimated_alpha_save


# create the dict to save
# parameter section and data section
save_dict = {"parameters": {"Gibbs sampling iterations": inf_rep,
                            "signal_dimension": 2,
                            "alpha true value": alpha,
                            "a_min": a_min,
                            "a_max": a_max,
                            "Sequence_length": T,
                            "length_of_coef_vector": li_coef_length
                            },
             "data": data_dict}
...
# the file name
file_name = "exp23-data-" + time_string + "(YSP_bivariate_new_model_update).pickle"
