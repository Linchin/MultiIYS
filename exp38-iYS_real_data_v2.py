...
def load_seq(begin, end, channel):
    ...
    total_length = math.floor((end-begin)*1000)
...
total_length = math.floor((end_time-begin_time)*1000)
print("delay time: ", end_time-begin_time)
print("Sampling rate: 1kHz")
print("Spike sequence length: ", total_length)

channels = ["ch099pos1", "ch105pos1"]
all_channel_data = dict()
...
#        aprob_history = regime_detection.aprob_history
 ...
 #       data_dict[rep_exp_index]["aprob"] = aprob_history
    ...
    # the file name
    file_name = "exp38-data-" + time_string + "(gibbs_real_data_v2).pickle"
