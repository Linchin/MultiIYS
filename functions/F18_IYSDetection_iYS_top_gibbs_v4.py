...
File name:
F17_IYSDetection_iYS_top_gibbs_v3.py
...
F17 notes 11/16/2020
based on F14, this is for bulk processing
return the gibbs sampling results
...
class IYSDetection_iYS_top_gibbs:
    ...
    def __init__(self, network_size, gibbs_rep, gibbs_alpha_rep, required_time):
        ...
        self.__adjacency_mat_e_history = {}  # type: Dict[int: nparray]
    ...
    def __estimate_update(self):
        ...
        for gibbs_rep_index in range(self.__gibbs_rep):
            ...
            self.__model_count = model_count.copy()
            # (current_adj_matrix)
            # print(model_count)
